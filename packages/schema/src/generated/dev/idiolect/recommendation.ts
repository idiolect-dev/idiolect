...
import type { Basis, Caveat, LensRef, LpChecker, LpCoercionLaw, LpConformance, LpConvergence, LpGenerator, LpRoundtrip, LpTheorem, SchemaRef, VocabRef } from "././defs";
...
*/
export interface ConditionActionSubsumedBy {
  /**
