...
```toml
idiolect-oauth = { git = "https://github.com/idiolect-dev/idiolect", tag = "v0.13.0", features = ["store-filesystem"] }
```
...
```toml
idiolect-oauth = { git = "https://github.com/idiolect-dev/idiolect", tag = "v0.13.0", features = ["store-sqlite"] }
```
