...
mod tests {
    ...
    fn stage_identity() -> (String, InMemoryResolver, InMemorySchemaLoader) {
        ...
        let src_hash = "sha256:src-rt".to_owned();
        let tgt_hash = "sha256:tgt-rt".to_owned();
    ...
    async fn missing_lens_uri_is_invalid_input() {
        ...
        let mut target = target("ignored".into());
    ...
    async fn unresolvable_lens_surfaces_lens_error() {
        ...
        let t = target("at://did:plc:x/dev.panproto.schema.lens/missing".into());
