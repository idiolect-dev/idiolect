...
impl EntityKind {
    ...
    const fn rust_record_type(self) -> &'static str {
        match self {
            ...
            Self::ChangeProposal => "idiolect_records::ChangeProposal",
            Self::Community => "idiolect_records::Community",
            Self::CommunityRelease => "idiolect_records::CommunityRelease",
            Self::Dialect => "idiolect_records::Dialect",
            Self::Federation => "idiolect_records::Federation",
            Self::MigrationRun => "idiolect_records::MigrationRun",
    ...
    const fn catalog_accessor(self) -> &'static str {
        match self {
            ...
            Self::ChangeProposal => "change_proposals",
            Self::Community => "communities",
            Self::CommunityRelease => "community_releases",
            Self::Dialect => "dialects",
            Self::Federation => "federations",
            Self::MigrationRun => "migration_runs",
